...
| [Edge Social Aggregator]({{ '/en/skills/edge-social-aggregator/' | relative_url }}) | Score and consolidate social trading signals (from social-signal-ingestor's YouTube/X/Reddit vault) into a per-ticker... | <span class="badge badge-free">No API</span> |
...
| [Social Signal Ingestor]({{ '/en/skills/social-signal-ingestor/' | relative_url }}) | Ingest trading signals from YouTube channels — fetch video transcripts via yt-dlp, then extract one structured signal... | <span class="badge badge-free">No API</span> |
...
| [Ticker Enricher]({{ '/en/skills/ticker-enricher/' | relative_url }}) | Enrich ticker signals with company metadata (name, sector, industry) and prices (recommendation-date price, current p... | <span class="badge badge-free">No API</span> |
