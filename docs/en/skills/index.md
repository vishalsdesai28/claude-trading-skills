...
|-------|-------------|-----|
| [Adversarial Trade Debate]({{ '/en/skills/adversarial-trade-debate/' | relative_url }}) | Turn a screener candidate into a decisive conviction rating and a sized, risk-vetted trade decision through two... | <span class="badge badge-free">No API</span> |
...
| [Data Quality Checker]({{ '/en/skills/data-quality-checker/' | relative_url }}) | Validate data quality in market analysis documents and blog articles before publication | <span class="badge badge-free">No API</span> <span class="badge badge-optional">FMP Optional</span> |
| [Dealer Gamma Analyzer]({{ '/en/skills/dealer-gamma-analyzer/' | relative_url }}) | Quantify dealer options gamma (GEX) positioning for an equity or index from FREE CBOE delayed options data | <span class="badge badge-free">No API</span> |
...
| [Dynamic Exit Engine]({{ '/en/skills/dynamic-exit-engine/' | relative_url }}) | Manage an adaptive trailing exit for an open LONG equity position | <span class="badge badge-free">No API</span> <span class="badge badge-optional">FMP Optional</span> |
...
| [Edge Social Aggregator]({{ '/en/skills/edge-social-aggregator/' | relative_url }}) | Score and consolidate social trading signals (from social-signal-ingestor's YouTube/X/Reddit vault) into a... | <span class="badge badge-free">No API</span> |
...
| [Finviz Screener]({{ '/en/skills/finviz-screener/' | relative_url }}) ★ | Build and open FinViz screener URLs from natural language requests, or run a keyless yfinance multi-factor boolean... | <span class="badge badge-free">No API</span> <span class="badge badge-optional">FINVIZ Optional</span> |
...
| [Index Futures Weekly Income]({{ '/en/skills/index-futures-weekly-income/' | relative_url }}) | Generates trade signals for S&P 500 (ES/MES) and Nasdaq-100 (NQ/MNQ) index futures and their options - a... | <span class="badge badge-free">No API</span> |
...
| [Intrinsic Value Dcf]({{ '/en/skills/intrinsic-value-dcf/' | relative_url }}) | Produce a triangulated intrinsic-value estimate for a US ticker by blending a discounted-cash-flow (DCF) model,... | <span class="badge badge-api">FMP Required</span> |
...
| [Live Analytics Dashboard]({{ '/en/skills/live-analytics-dashboard/' | relative_url }}) | Render another skill's reports/* | <span class="badge badge-free">No API</span> |
...
| [Momentum Dca Bot]({{ '/en/skills/momentum-dca-bot/' | relative_url }}) | Fully mechanical daily momentum DCA system - screen momentum-pullback stocks (Yahoo Finance keyless, or Finviz... | <span class="badge badge-optional">FINVIZ Optional</span> <span class="badge badge-api">Alpaca Required</span> |
| [Morning Note Briefing]({{ '/en/skills/morning-note-briefing/' | relative_url }}) | Assemble a fixed-format, two-minute pre-market morning note by composing the JSON outputs of existing skills —... | <span class="badge badge-free">No API</span> |
...
| [Position Sizer]({{ '/en/skills/position-sizer/' | relative_url }}) ★ | Calculate risk-based position sizes for long stock trades | <span class="badge badge-free">No API</span> <span class="badge badge-optional">FMP Optional</span> |
| [Retail Sentiment Ingestor]({{ '/en/skills/retail-sentiment-ingestor/' | relative_url }}) | Ingest real-time retail sentiment for a list of tickers from StockTwits cashtag streams and Reddit... | <span class="badge badge-free">No API</span> |
| [Robinhood Trade Executor]({{ '/en/skills/robinhood-trade-executor/' | relative_url }}) | Auto-buy newly surfaced long-stock signals on Robinhood | <span class="badge badge-free">No API</span> |
...
| [Short Squeeze Radar]({{ '/en/skills/short-squeeze-radar/' | relative_url }}) | Rank US equities by short-squeeze potential using FREE FINRA data (no API key) | <span class="badge badge-free">No API</span> |
...
| [Social Signal Ingestor]({{ '/en/skills/social-signal-ingestor/' | relative_url }}) | Ingest trading signals from YouTube channels — fetch video transcripts via yt-dlp, then extract one structured... | <span class="badge badge-free">No API</span> |
...
| [Swing Setup Screener]({{ '/en/skills/swing-setup-screener/' | relative_url }}) | Seven-in-one EOD screener over keyless Yahoo daily bars — swing-trend longs (SMA50/200 alignment +... | <span class="badge badge-free">No API</span> |
...
| [Ticker Enricher]({{ '/en/skills/ticker-enricher/' | relative_url }}) | Enrich ticker signals with company metadata (name, sector, industry) and prices (recommendation-date price, current... | <span class="badge badge-free">No API</span> |
...
| [Trend Reclaim Screener]({{ '/en/skills/trend-reclaim-screener/' | relative_url }}) | After-hours screener for long-side SMA50 reclaim setups — stocks that pulled back below their 50-day moving average,... | <span class="badge badge-free">No API</span> |
...
| [Write Supabase]({{ '/en/skills/write-supabase/' | relative_url }}) | Generic Supabase table writer | <span class="badge badge-free">No API</span> |
